...
* Problem: Test LDAP database no longer matched current schema and was an a tiny subset.
  * Result: Developed perl script to replicate sanitized corporate dumps to a new test LDAP database
  * Result: Uncovered scalability issues in a released product
...
* Problem:  Routing database bulk load would truncate at strange round number
  * Result:  Discovered mysql indexing bug.  Developed procedure modification to handle bug

### Technical Support Specialist -- IBM -- 2003 Oct to 2005 Oct

* Problem:  Customer had problem with LDAP auth and product
  * Result:  Self taught enough LDAP to provide OpenLDAP server with posix schema and sample users to reproduce problem for developers

### Senior Systems Architect -- JDS Uniphase -- 2003 Feb to 2003 Oct

* Problem:  JDS Uniphase could not afford facilities and infrastructure costs from company that sold them an optical transcienver unit
  * Solution:  Replicate their licensed subset of EDA tools, technology libraries, chip designs, and mechanical designs to JDS Uniphase owned infrastructure in five weeks.
...
* Earned bo cha dan rank December 2017.
* Working towards first dan black belt late 2019.
...
* [Built ZFS on Linux based home file server including Debian on ZFS root](https://github.com/cdd-aix/debian-stretch-zfs-root)
* [Converted from vim to emacs in 2017](https://github.com/cdd-aix/emacs)
* Crafted auto-provisioning vagrant based FreeBSD autobuild system
...
Python, Perl, Bourne Shell, smalltalk, VB Script, DOS/Windows batch, golang, awk, sed, ruby, lisp, rexx

### Databases

DB2, Oracle, Informix, Postgres, Microsoft SQL, sqlite, Access, MySQL, MongoDB, LDAP (OpenLDAP, IBM Directory Server)
...
Jenkins (including pipelines), make (gnu and BSD), autoconf/automake
